...
DomainErrorTranslator._directories = {
  ...
  'ADD_THREAD.TITLE_LIMIT_CHAR': new InvariantError('tidak dapat membuat thread baru karena karakter thread melebihi batas limit'),
  'THREAD_REPOSITORY.NOT_FOUND': new NotFoundError('thread tidak ditemukan'),
  'THREAD_REPOSITORY.CANNOT_ACCESS': new AuthorizationError('thread tidak dapat diakses karena bukan owner'),
  'COMMENT_REPOSITORY.NOT_FOUND': new NotFoundError('comment tidak ditemukan'),
  'COMMENT_REPOSITORY.CANNOT_ACCESS': new AuthorizationError('comment tidak dapat diakses karena bukan owner'),
  'REPLY_REPOSITORY.NOT_FOUND': new NotFoundError('reply tidak ditemukan'),
  'REPLY_REPOSITORY.CANNOT_ACCESS': new AuthorizationError('reply tidak dapat diakses karena bukan owner'),
  ...
  'ADD_COMMENT.CONTENT_LIMIT_CHAR': new InvariantError('tidak dapat membuat comment baru karena content melebihi batas limit'),
  ...
  'ADD_REPLY.CONTENT_LIMIT_CHAR': new InvariantError('tidak dapat membuat reply baru karena content melebihi batas limit'),
};
